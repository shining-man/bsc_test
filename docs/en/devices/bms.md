...
- **Address Singlepack**: This address is the one that has to be set on both the BMS and Device-Data mapping. It represents the specific address for a single BMS in a system.
