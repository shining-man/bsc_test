...
[Configuration of the BSC](settings_bsc.md)  

If you want to test the BSC software without original hardware, you should have the chapter
[Test without orig. Hardware](BSC_ohne_orig_hardware.md) Read.  
...
To do this, first download the current release (BSC_Firmware.zip) from [here](https://github.com/shining-man/bsc_fw/releases) to unzip it.  Now you will find a file called "firmware.bin" that represents the firmware to be flashed.  
...
The current releases can be found [here](https://github.com/shining-man/bsc_fw/releases).  
...
The software for flash (flash download tools) can be obtained from the manufacturer's website of the ESP32 via [this link](https://www.espressif.com/en/support/download/other-tools).  
