...
# BSC display
The display for the BSC was spun into a [separate project](https://github.com/shining-man/bsc_display) in which the firmware can also be found.
