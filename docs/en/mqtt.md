...
In addition, it can be determined for each Vtrigger whether it should be saved. These settings are under "System" on the [MQTT options](settings_bsc.md/#mqtt).
...
You can generate this, for example, with "Version 1" on https://www.uuidgenerator.net/version1.
...
### Useful tools
Automatic creation of the BSC in HA: <a href="https://github.com/dominikfe/ha_bsc_discovery_automation" target="_blank"> https://github.com/dominikfe/ha _BSC_ Discovery_Automation </a>