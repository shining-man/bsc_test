...
Further information can be found [here](settings_bsc.md#serial) under "Operating mode 2: Linear SOC calculation between two cell voltage thresholds".
...
A short **video** can also be found [here](mov/serial_debugging.mp4).  
...
Further information [here](hardware.md#j6-fur-den-regularen-betrieb).
